...
This new file sets the correct radio frequencies for the US region. Note that this moved the existing configuration file (with European frequencies) to `global_conf.json.1`.
